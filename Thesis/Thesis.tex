...
\begin{itemize}
    ...
    \subitem \#3: Better specifications can be found by changing their ``focus''.
...
The most difficult of these is of course finding a solution to the problem, but we didn't touch this topic, as it is well-described elsewhere and taught to most undergraduates worldwide. Finding good specifications is also pretty hard -- our techniques help mostly with evaluating or modifying them.

\section{Contributions, related and further work}
...
\paragraph{Contributions}{I consider this thesis to be a work of pedagogy rather than one of research -- basically, it's a lengthy tutorial intended to be accessible to people with only rudimentary knowledge of Coq. I have discovered some of the techniques presented here semi-autonomously, but I don't take any credit. For example, I ``knew'' about (hole-) and (type-)driven development before starting this project, but I had to reinvent the wheel from scratch myself, driven purely by the needs of proof engineering, in order to really grasp, absorb and assimilate it. My only original addition to it is the idea of abstracting over holes, which I haven't seen described anywhere else, but I'm pretty sure that people more knowledgeable on the matter have also encountered this idea.

Some techniques presented here, like functional induction, are well-known, but there was a lack of good expository material, which I provided in section \ref{funind}. Others, like the Bove-Capretta method, are both well-known and well-described in the literature, but these descriptions are fragmented between different papers, some of them paywalled, most of them jargony and directed at insiders in the field. I rectified the situation by giving this method a more friendly name -- the inductive domain method -- and providing a beginner-friendly introduction in section \ref{inductivedomain}. Yet other techniques, like proof by admission, are probably very well-known, but it is hard to check this fact, because they lack a standard name (well, they lacked it until section \ref{byadmission}). This is a serious problem, because it is very hard to refer to nameless things, hard to think about them and hard to teach them. I am also not aware of any tutorials or other expository texts on proof by admission.

The greatest contribution of this thesis, however, is simply putting all of these useful concepts and techniques together 
