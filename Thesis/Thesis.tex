...
We won't explain how this proof idea is actually carried out, because any such an explanation would be far less enlightening than just going over the proof script in CoqIDE. We will only gloss over the meaning of tactics that were used:
...
\begin{itemize}
    ...
    \item \m{rewrite}, given a hypothesis that is an equation, replaces the occurrences of its left-hand side its right-hand side in the goal or another hypothesis.
...
\begin{itemize}
    \item Software Foundations \cite{SoftwareFoundations} is a very beginner-friendly textbook, aimed at teaching Coq fundamentals to 
\end{itemize}
