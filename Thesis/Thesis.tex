...
We are now ready to make the last step in our grand journey for formally verified quicksort: prove correctness of our template (and then, as a sanity check, of a default concrete implementation too).
