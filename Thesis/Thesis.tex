...
\bibitem{FunctionRefman}
    ...
    \textit{Functional induction}, \\
    \url{https://coq.inria.fr/refman/using/libraries/funind.html}
...
\bibitem{SlidingAdmit}
    F* wiki, \textit{Sliding admit verification style}, \\
    \url{https://github.com/FStarLang/FStar/wiki/Sliding-admit-verification-style}

\bibitem{Typeful}
    Luca Cardelli,
    \textit{Typeful Programming}, 1991 \\
    \url{http://www.lucacardelli.name/Papers/TypefulProg.pdf}

\bibitem{TypeDriven}
    Edwin Brady,
    \textit{Type-Driven Development with Idris},
    2017 \\
    \url{https://www.manning.com/books/type-driven-development-with-idris}

\bibitem{TypeFirst}
    Tomas Petricek,
    \textit{Why type-first development matters},
