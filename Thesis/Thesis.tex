...
Most of what we've been doing lately was pretty boring. Given the cleanest definition of the algorithm we saw back in chapter \ref{template}, when we weren't concerned with the termination proof and the functional induction principle, can be derived automatically:
