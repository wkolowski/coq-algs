...
The rationale behind the technique is quite simple. Users are usually lazy -- they want good effects with low effort, and a decent default implementation provides just that. But not only are users low effort, they want the \textit{least effort}. In our case, this translates 
...
%TODO: opisać alternatywny dizajn, gdzie to QSDom_all ma wyłączony termination checker
