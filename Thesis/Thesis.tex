...
Imperative algorithms and data structures are pretty much synonymous with competitive programming, dominating most in-person and online computer science competitions like ICPC and HackerRank, respectively. They are seen as the thing that gifted high school students interested in computer science should pursue -- each time said students don't win medals in the International Olympiad in Informatics, there will be some journalists and politcians complaining about the state of the country's education system.

Imperative algorithms and data structures don't form a mere field of study -- they are more of a mindset and a culture than a field; in short, they form a paradigm. Because this paradigm is so overarching, so powerful and so entrenched, we feel free to completely disregard it and instead devote ourselves and this thesis to something completely unlike it -- the formal verification of functional algorithms and data structures.
