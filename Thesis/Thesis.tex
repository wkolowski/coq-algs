...
\begin{itemize}
    \item The extremely practical, in which the specification and proof are dropped in favour of the test suite, the pseudocode is dropped in favour of the actual implementation, and the complexity analysis is only cursory and performed on the go, in the algorithmists head during the design phase. This approach permeates in comeptitive programming, because of the time pressure, and industry, because most ``algorithms'' there amount to unsophisticated data processing that doesn't need specification or proof.
...
\begin{itemize}
    \item Can the specification and the proof really be formalized in 
    \item Does the pseudocode really describe an algorithm that meets the informal specification? Is the pen-and-paper proof correct?
