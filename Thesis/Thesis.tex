...
\begin{center}
    \textbf{Formally verified algorithm concept/technique \#--1} \\
    Find a specification of the problem's solution that is both abstract and easy to use.
\end{center}
...
\concept{Implement an abstract template that captures the idea behind the algorithm. You can ignore the matter of termination at first.}
